...
import com.project.pagu.global.validation.OauthSignUpValidation;
...
import com.project.pagu.domain.member.service.MemberSaveService;
import com.project.pagu.global.util.SignUpManager;
import com.project.pagu.global.validation.SignUpValidation;
...
public class SignUpController {
    ...
    public void initBinderSignUpDto(WebDataBinder webDataBinder) {
        webDataBinder.setValidator(signUpValidation);
    }
    ...
    public String submitSignUpGoogle(@CurrentMember Member member, @Valid OauthSaveDto oAuthSaveDto,
        ...
        oauthSignUpValidation.validate(oAuthSaveDto, result);
        if (result.hasErrors()) {
            return "members/sign-up/google";
        }
